...
| 用途 | size | weight | line-height | color | letter-spacing | font |
|------|------|--------|-------------|-------|----------------|------|
| タイトルスライド見出し | 56px | 300 | 1.1 | #000000 | -1.5px | Serif |
| スライド見出し | 44px | 300 | 1.15 | #000000 | -1px | Serif |
| カードタイトル | 28px | 600 | 1.3 | #000000 | -0.3px | Serif |
| 本文（スライド基準） | 20px | 400 | 1.6 | #1a1a1a | 0 | Sans |
| カード本文 | 18px | 400 | 1.6 | #525252 | 0 | Sans |
| ラベル(uppercase) | 14px | 700 | 1.2 | #6b6b6b | 2px | Sans |
| 数値ハイライト(大) | 64px | 300 | 1.0 | #000000 | 0 | Serif |
| 数値ハイライト(小) | 48px | 300 | 1.0 | #000000 | 0 | Serif |
| 装飾番号 | 72px | 300 | 1.0 | #c4c4c4 | 0, opacity 0.4 | Serif |
| サブタイトル | 28px | 300 | 1.4 | #525252 | -0.5px | Serif |
| 連絡先 | 18px | 400 | 1.5 | #6b6b6b | 0 | Sans |
| URL (mono) | 16px | 400 | 1.5 | #8a8a8a | 0 | Mono |
| スライド番号 (mono) | 12px | 500 | 1.0 | #8a8a8a | 0 | Mono |
| copyright (mono) | 10px | 400 | 1.0 | #8a8a8a | 0 | Mono |
